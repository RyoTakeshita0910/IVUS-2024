...
parser.add_argument("--input_dir", type=str, required=True, help='path to the folder containing origial pngs')
...
def set_path(target, data_list, path):
